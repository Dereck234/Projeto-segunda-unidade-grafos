...
export default function App() {
  ...
  function handleEntrar(usuario: Usuario | null) {
  ...
  const iniciais = (usuarioLogado?.nome ?? 'Visitante')
    .split(' ')
    .map(p => p[0])
    .slice(0, 2)
    .join('')
        ...
        <div className="header-inner">
          ...
          <div className="header-right">
            ...
            <div className="user-chip">
              ...
              <span>{usuarioLogado?.nome ?? 'Visitante'}</span>
      ...
      <main className="main">
        {aba === 'recomendacoes' && (
          <Recomendacoes
            usuarios={usuarios}
            livros={livros}
            usuarioInicial={usuarioLogado ? String(usuarioLogado.id) : undefined}
          />
        )}
        {aba === 'rede' && (
